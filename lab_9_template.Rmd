...
# Colinearity is messing with the model!
...
# Pick final, even though AIC shows that the sat_aic is lower "better". I would still pick homes_lm3, because: Overall, heteroscedasticity is OK, residuals normality definitely looks good, and conceptually and mathematically my model is making sense!
...
lm_table
#consider taking out lm_table, could make R happier
...
df_new <- data.frame(City = rep(c("San Luis Obispo", # rep = repeat
                                  "Santa Maria-Orcutt",
                                  "Atascadero",
                                  "Arroyo Grande"), 
                                each = 60), 
